...
const About = () => {
  ...
  const diferencaMeses =
    (dataAtual.getFullYear() - dataJulho2023.getFullYear()) * 12 +
  ...
  return (
    <div className="lg:mx-[20%] mx-[10%] lg:mt-[4%] mt-[10%] h-[150vh]">
      <h1 className="text-4xl font-bold lg:mb-0 mb-[10%]">
        Olá, sou a Helena ✌
      </h1>
      <div className="flex lg:flex-row flex-col justify-between items-center gap-10">
        <div className="lg:w-[600px] text-left flex flex-col gap-4 font-thin">
          <p>
            Meu nome é{" "}
            <span className="border-b border-zinc-300">Helena Carvalho</span>
          </p>
          <p>
            Sou uma programadora Front-end com 1 ano de experiência profissional
            e uma paixão avassaladora pela tecnologia!
          </p>
          <p>
            Ao longo da minha trajetória como entusiasta e programadora
            front-end, adquiri experiência em metodologias ágeis como Scrum.
            Estou disponível para contribuir com meus conhecimentos em JS, TS,
            React, Next.js e Node.js para a sua equipe.
          </p>
          <p>
            Além disso, estou ativamente aprimorando minhas habilidades e
            expondo elas no meu <span>Github</span>
          </p>
        </div>
        <img
          src="https://assets-global.website-files.com/64c73d04a946980a4476537e/64d454e5665c7e4ace18d43d_Meela%20Pantalones.svg"
          alt="Menina sentada refletindo"
      ...
      <div className="font-thin mt-4">
        ...
        <p className="mt-5 mb-2">
          <span className="border-b">GlobalSys Soluções em TI</span> • Remoto{" "}
        </p>
        <p>Jul 2023 - Momento • {diferencaMeses} meses </p>
        {!showResume ? (
          <div className="flex items-center">
            <button onClick={() => setShowResume(true)}>
              <MdExpandMore size={30} className="" />
            </button>
            <p>Veja mais</p>
          </div>
        ) : (
          <div className="flex items-center">
            <button onClick={() => setShowResume(false)}>
              <MdExpandMore size={30} className="rotate-180" />
            </button>
            <p>Veja menos</p>
          </div>
        )}
        {showResume && (
          <div className="mt-4">
            <p>
              •Realizar o desenvolvimento de softwares e a manunteção em
              componentes já existentes utilizando ReactJS
            </p>
            <p>• Corrigir bugs no código</p>
            <p>
              • Utilizar as ferramentas styled-components e TailwindCSS para
              criar estilo de forma mais eficiente e flexível
            </p>
            ...
            <p>
              • Mantive-me atualizada com as tendências e tecnologias da
              indústria através de aprendizado contínuo.
            </p>
          </div>
        )}
      </div>
