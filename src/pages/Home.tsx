...
const Home = () => {
  return (
    <div className="lg:mx-[20%] lg:mt-[4%] mx-10 flex lg:flex-row-reverse flex-col lg:justify-around items-center lg:gap-0 gap-14">
      <div className="lg:mt-0 mt-[30%]">
        <div>
          ...
          <p className="text-3xl font-thin mt-4">
            Meu nome é{" "}
            <span className="border-b border-zinc-500">Helena Carvalho</span>
          </p>
      ...
      <img
        src="https://assets-global.website-files.com/64c73d04a946980a4476537e/64d455276eae71b4f2472b6d_New%20Beginnings.svg"
        alt="Foto ilustrativa de garota sentada no sofá lendo jornal"
